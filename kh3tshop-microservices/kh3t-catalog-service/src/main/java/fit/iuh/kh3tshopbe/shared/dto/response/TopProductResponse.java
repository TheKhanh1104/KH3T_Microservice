...
public class TopProductResponse {
    ...
    private int sales; private double revenue;
    private String trend; private String img;
    ...
    public TopProductResponse(String name, String category, int sales, double revenue, String trend, String img) {
        this.name = name; this.category = category; this.sales = sales;
        this.revenue = revenue; this.trend = trend; this.img = img;
    }
