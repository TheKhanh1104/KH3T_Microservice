...
public class Product {
    ...
    public Product(int id, String name, String description, double price, double costPrice, String unit, int quantity, String imageUrlFront, String imageUrlBack, Date createdAt, Date updatedAt, String brand, double rating, Category category, double discountAmount, String material, String form, Status status, List<SizeDetail> sizeDetails) {
        this.id = id;
        this.name = name;
    ...
    public static class ProductBuilder {
        ...
        public Product build() {
            return new Product(id, name, description, price, costPrice, unit, quantity, imageUrlFront, imageUrlBack, createdAt, updatedAt, brand, rating, category, discountAmount, material, form, status, sizeDetails);
        }
    }
}